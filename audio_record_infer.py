...
os.makedirs(os.path.join(audio_dir, "RT_infer"), exist_ok = True)
...
print("Please provide your audio for verification.")
...
"""for i in range(recordings):
    ...
    print("Writing the audio to ", os.path.join(os.path.join(audio_dir, "RT_infer"), filename))
    # save audio file
    # open the file in 'write bytes' mode
    wf = wave.open(os.path.join(os.path.join(audio_dir, "RT_infer"), filename), "wb")
    # set the channels
